<!-- Header
================================================= -->
@extends('templates.origin')
<!--Header End-->
@section('title', 'Avenir')
    ...
    <div style="border:1px solid red">
        ...
        <div class="post-container">
            ...
            <div class="post-detail">
                ...
                <div class="post-comment">
                    ...
                    <p><a href="timeline.html" class="profile-link">Prénom Nom </a><i
                ...
                <div class="post-comment">
                    ...
                    <p><a href="timeline.html" class="profile-link">Prénom Nom</a> Lorem ipsum dolor sit
        ...
        <div class="post-content">
            ...
            <div class="post-container">
                ...
                <div class="post-detail">
                    <div class="user-info">
                        <h5><a href="timeline.html" class="profile-link">Sophia Lee</a> <span class="following">following</span>
                        </h5>
                    ...
                    <div class="post-comment">
                        ...
                        <p><a href="timeline.html" class="profile-link">Olivia </a> Lorem ipsum dolor sit amet,
            ...
            <div class="post-container">
                ...
                <div class="post-detail">
                    ...
                    <div class="post-comment">
                        ...
                        <p><a href="timeline.html" class="profile-link">Brian </a>Sed ut perspiciatis unde omnis
                    ...
                    <div class="post-comment">
                        ...
                        <p><a href="timeline.html" class="profile-link">Richard</a> Lorem ipsum dolor sit amet,
                            consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
                            magna aliqua. </p>
                    </div>
                    <div class="post-comment">
        ...
        <div class="post-content">
            <div class="post-container">
                ...
                <div class="post-detail">
                    ...
                    <div class="post-comment">
                        <img src="images/users/user-1.jpg" alt="" class="profile-photo-sm"/>
                        <p><a href="timeline.html" class="profile-link">Sarah </a>Sed ut perspiciatis unde omnis
                            iste natus error sit voluptatem accusantium doloremque laudantium, totam rem
                            aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae
        ...
        <div class="post-content">
            ...
            <div class="post-container">
                ...
                <div class="post-detail">
                    <div class="user-info">
                        <h5><a href="timeline.html" class="profile-link">Anna Young</a> <span class="following">following</span>
                        </h5>
